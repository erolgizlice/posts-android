...
/**
 * Single source of truth for posts: reads are observed, writes are commands. A screen never hands
 * a result to another screen; it changes the posts here and every observer sees the new list.
 */
